 ...
 */
inline void ScanInput() { hidScanInput(); }

/**
 * @brief Gets the keys that were just pressed.
 */
inline u32 GetKeysPressed() { return hidKeysDown(); }

/**
 * @brief Gets the keys that are currently being held.
 */
inline u32 GetKeysHeld() { return hidKeysHeld(); }

/**
 * @brief Gets the keys that were just released.
 */
inline u32 GetKeysReleased() { return hidKeysUp(); }
