...
int main(int argc, char *argv[]) {
  ...
  while (xs::sys::MainLoop()) {
    ...
    // Draw rectangles
    C2D_DrawRectSolid(50, 50, 0.5f, 100, 50, clrRec1);
    C2D_DrawRectSolid(100, 80, 0.4f, 100, 50, clrRec2);
    C2D_DrawRectSolid(150, 110, 0.3f, 100, 50, clrRec3);
    C2D_DrawRectSolid(200, 140, 0.2f, 100, 50, clrRec4);
